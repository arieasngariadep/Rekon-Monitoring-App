...
class BniSearchBulkTolakanExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder, WithColumnFormatting{
    ...
    */
    ...
    {
        $data = BniModel::getReportSearchBulkExportTolakan($this->userId);
