...
<li class="breadcrumb-item active">Form Update Bulk Tolakan BNI</li>
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Update Bulk Tolakan BNI</h4>
                ...
                <form action="{{ route('prosesUpdateBulkTolakan') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
